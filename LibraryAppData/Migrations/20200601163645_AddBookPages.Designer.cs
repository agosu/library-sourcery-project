...
namespace LibraryAppData.Migrations
{
    ...
    [Migration("20200601163645_AddBookPages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryAppData.Models.LibraryBalanceView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryAppData.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LibraryAppData.Models.User", b =>
                {
                    ...
                    b.Property<bool>("AppNotiOnBookAvailable")
                        .HasColumnType("bit");

                    b.Property<bool>("AppNotiOnNewBook")
                        .HasColumnType("bit");

                    b.Property<bool>("AppNotiOnReturnDate")
                        .HasColumnType("bit");

                    b.Property<string>("Email")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("EmailNotiOnBookAvailable")
                        .HasColumnType("bit");

                    b.Property<bool>("EmailNotiOnReturnDate")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AppNotiOnBookAvailable = true,
                            AppNotiOnNewBook = true,
                            AppNotiOnReturnDate = true,
                            Email = "tom@email.com",
                            EmailNotiOnBookAvailable = true,
                            EmailNotiOnReturnDate = true,
            ...
            modelBuilder.Entity("LibraryAppData.Models.User", b =>
                {
                    ...
                    b.HasOne("LibraryAppData.Models.Role", "Role")
                        .WithMany()
